...
class SMSIntensifier(AbstractRacer):
    r"""Races challengers against an population-based incumbent based on S-Metric.
    TODO: Replace with SMS based intensification
    ...
    minimum_population_size : int
        minimum population size of the incumbent. When there are more points on the
        non-dominated front, the population size of the incumbent can become larger
    maximum_population_size: int
        maximum population size of the incumbent. When there are more points on the
        non-dominated front, the points that contribute the least to the HV are dropped.
    ...
    def __init__(
        ...
        min_chall: int = 2,
        minimum_population_size: int = 1,
        maximum_population_size: int = np.inf,
    ):
        super().__init__(
            stats=stats,
